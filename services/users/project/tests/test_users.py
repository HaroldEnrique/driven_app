...
class TestUserService(BaseTestCase):
    ...
    def test_add_user(self):
        ...
        with self.client:
            ...
            self.assertIn('haroldcotacallapa@upeu.edu.pe was added!',
                          data['message'])
            self.assertIn('success', data['status'])
    ...
    def test_single_user(self):
        ...
        with self.client:
            ...
            self.assertIn('haroldcotacallapa@upeu.edu.pe',
                          data['data']['email'])
            self.assertIn('success', data['status'])
    ...
    def test_all_users(self):
        ...
        with self.client:
            ...
            self.assertIn('harold.enrique',
                          data['data']['users'][0]['username'])
            self.assertIn('haroldcotacallapa@upeu.edu.pe',
                          data['data']['users'][0]['email'])
            self.assertIn('harolcotac',
                          data['data']['users'][1]['username'])
            self.assertIn('harolcotac@gmail.com',
                          data['data']['users'][1]['email'])
            self.assertIn('enriquecotac',
                          data['data']['users'][2]['username'])
            self.assertIn('enriquecotac@gmail.com',
                          data['data']['users'][2]['email'])
            self.assertIn('harrington',
                          data['data']['users'][3]['username'])
            self.assertIn('harrington@gmail.com',
                          data['data']['users'][3]['email'])
            self.assertIn('alisson',
                          data['data']['users'][4]['username'])
            self.assertIn('m.alisson@gmail.com',
